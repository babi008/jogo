...
const levelMessages = {
  ...
  "13": "😎 Encarou os 13 com atitude!",
  "15": "🔥 15 anos de coragem!",
  "16": "🚗 Quase maior de idade!",
  "17": "🎯 Um passo da liberdade!",
...
document.addEventListener("keydown", (e) => {
  if (e.code in keys) {
    ...
    if (e.code === "ArrowUp") {
      player.src = "imagem/download (1).png"; // Imagem cabeça pra cima
      player.style.bottom = "";
      player.style.top = "0";
      isOnTop = true;
    }
    ...
    if (e.code === "ArrowDown") {
      player.src = "imagem/download (2).png"; // Imagem cabeça pra baixo (invertida)
      player.style.top = "";
...
// Animação de comemoração com pulo e confetes
function celebrate() {
